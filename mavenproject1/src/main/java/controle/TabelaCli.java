...
public class TabelaCli extends JFrame {
    ...
    public TabelaCli() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (con_cliente.resultset.first()) {
                        ...
                        JOptionPane.showMessageDialog(null, "\n Não existe dados com este pramêtro!!",
        ...
        bprimei.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Não foi possível acessar o primeiro registro: " + erro.getMessage());
                }
            }
        });
        ...
        banterior.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Não foi possível acessar o registro anterior: " + erro.getMessage());
                }
            }
        });
        ...
        bproximo.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Não foi possível acessar o próximo registro: " + erro.getMessage());
                }
            }
        });
        ...
        bultimo.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Não foi possível acessar o último registro: " + erro.getMessage());
                }
            }
        });

        bnovoregistro = new JButton("Novo Registro");
        bnovoregistro.setBounds(600, 210, 140, 20);
        ...
        bgravar.setBounds(600, 230, 140, 20);
        ...
        balterar.setBounds(600, 250, 140, 20);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    if (tCodigo.getText().equals("")) {
                        sql = "insert into tbclientes (nome,telefone,email,dt_nasc) values ('" + nome + "','" + telefone
                                + "','" + email + "','" + dt_nasc + "')";
                        msg = "Gravação de um novo registro";
                    } else {
                        sql = "Update tbclientes set nome='" + nome + "', telefone='" + telefone + "', email='" + email
                                + "', dt_nasc='" + dt_nasc + "'where cod=" + tCodigo.getText();
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (resp == 0) {
                        ...
                        JOptionPane.showMessageDialog(null, "Operação cancelada pelo usuário!!", "Mensagem do Programa",
                                JOptionPane.INFORMATION_MESSAGE);
                    }
                } catch (SQLException excecao) {
                    JOptionPane.showMessageDialog(null, "Erro na Exclusão: " + excecao, "Mensagem do Programa",
                            JOptionPane.INFORMATION_MESSAGE);
                }
            }
        });
        ...
        bdeslogar.setBounds(600, 320, 140, 20);
        bdeslogar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                LoginCli mostra = new LoginCli();
    ...
    public void mostrar_Dados() {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Não localizou dados: " + erro.getMessage(), "Mensagem do Programa",
                    JOptionPane.INFORMATION_MESSAGE);
        }
    }
}
